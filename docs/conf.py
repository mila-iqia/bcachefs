...
breathe_projects = {"bcachefs": doxygen_out_xml}
# -----------------------------------------------------------------------
...
man_pages = [(master_doc, "bcachefs", "bcachefs Documentation", [author], 1)]
