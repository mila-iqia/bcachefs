...
# -*- coding: utf-8 -*-
"""
bcachefs documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'bcachefs'))
...
doxygen_out = os.path.join(docs_src_path, '_build')
...
breathe_default_project = "bcachefs"
...
htmlhelp_basename = 'bcachefs-doc'
...
latex_documents = [
    (master_doc, 'bcachefs.tex', u'bcachefs Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'bcachefs', 'bcachefs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bcachefs', 'bcachefs Documentation',
     author, 'bcachefs', 'Fast Dataset Archive for HPC',
     'Miscellaneous'),
]
